...
Upload des captures CIN vers MinIO.
"""
import io
import os
...
class MinioService:
    def __init__(self) -> None:
        ...
        # Si MINIO_ENDPOINT contient déjà le port (ex: "localhost:9000") on l'utilise tel quel
    ...
    def upload_image(self, image_bytes: bytes, capture_id: str) -> str:
        object_name = f"cin/{capture_id}.jpg"
