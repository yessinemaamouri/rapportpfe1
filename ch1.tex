...
La structure organisationnelle de la BTE repose sur une gouvernance multi-niveaux, alliant direction générale, pôles métiers et directions supports. L'organigramme présenté en Figure~\ref{fig:ch1-organigramme} illustre cette hiérarchie fonctionnelle, au sein de laquelle la DCIO occupe une position stratégique transversale, en interface directe avec l'ensemble des directions opérationnelles.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{images/image_ch1/logo_bte.png}
...
\subsubsection*{\hspace{0.5cm} 1. Le KYC traditionnel}
...
\paragraph{\hspace{1cm} a. Processus hors ligne}
\mbox{}\\
...
\paragraph{\hspace{1cm} b. Processus en ligne}
\mbox{}\\
...
\paragraph{\hspace{1cm} c. Limites structurelles du KYC traditionnel}
\mbox{}\\
...
\subsubsection*{\hspace{0.5cm} 2. Le KYC automatisé (e-KYC)}
...
\subsubsection*{\hspace{0.5cm} 1. Normes internationales}
...
\subsubsection*{\hspace{0.5cm} 2. Réglementations nationales (Tunisie)}
...
\subsubsection*{\hspace{0.5cm} 1. KYC au sein de la BTE}
...
\subsubsection*{\hspace{0.5cm} 2. Solutions KYC commerciales disponibles}
...
\paragraph{\hspace{1cm} b. NEUROPARSER}
\mbox{}\\
...
\subsubsection*{\hspace{0.5cm} 1. CRISP-ML(Q) vs CRISP-DM}
...
\subsubsection*{\hspace{0.5cm} 2. Les six phases de CRISP-ML(Q)}
